...
export class CreateTableFatura1700945904755 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
                    ...
                    CREATE SEQUENCE public.id_fatura_seq
                        AS integer
                        START WITH 1
                        INCREMENT BY 1
                        NO MINVALUE
                    ...
                    ALTER SEQUENCE public.id_fatura_seq OWNED BY public.fatura.id;
                    
                    ALTER TABLE ONLY public.fatura ALTER COLUMN id SET DEFAULT nextval('public.id_fatura_seq'::regclass);
