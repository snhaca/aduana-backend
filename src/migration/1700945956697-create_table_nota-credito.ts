...
export class CreateTableNotaCredito1700945956697 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
                    ...
                    CREATE SEQUENCE public.id_nota_credito_seq
                        AS integer
                        START WITH 1
                        INCREMENT BY 1
                        NO MINVALUE
                    ...
                    ALTER SEQUENCE public.id_nota_credito_seq OWNED BY public.nota_credito.id;
                    
                    ALTER TABLE ONLY public.nota_credito ALTER COLUMN id SET DEFAULT nextval('public.id_nota_credito_seq'::regclass);
