...
export class CreateTableProforma1700945712385 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
                ...
                CREATE SEQUENCE public.id_proforma_seq
                    AS integer
                    START WITH 1
                    INCREMENT BY 1
                    NO MINVALUE
                ...
                ALTER SEQUENCE public.id_proforma_seq OWNED BY public.proforma.id;
                
                ALTER TABLE ONLY public.proforma ALTER COLUMN id SET DEFAULT nextval('public.id_proforma_seq'::regclass);
